    ...
    <section className="section about-section" id="about" aria-labelledby="about-heading">
      <div className="container about-grid">
        ...
        <div className="principles">
          ...
          <article className="reveal-delay-2" data-reveal><span className="mono">03</span><div><h3>Built for your actual needs</h3><p>The right solution starts with understanding the problem. I keep the scope focused and the foundations clear, with room to grow when you need it.</p></div></article>
        </div>
      </div>
    </section>
  );
