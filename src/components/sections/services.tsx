  ...
  return (
    <section className="section services-section" id="services" aria-labelledby="services-heading">
      <div className="container">
        <div className="section-heading" data-reveal><div><h2 className="eyebrow">01 / SERVICES</h2><p id="services-heading">Services I provide.<br /><span className="muted">Built around you.</span></p></div></div>
