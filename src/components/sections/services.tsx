  ...
  return (
    <section className="section services-section" id="services" aria-labelledby="services-heading">
      <div className="container">
        <div className="section-heading"><div><p className="eyebrow">01 / WHAT I DO</p><h2 id="services-heading">Your next step.<br /><span className="muted">Built around you.</span></h2></div><p>A new website, a clearer route to your customers, or a tool you wish existed. Let’s make it happen.</p></div>
        <div className="services-grid">{services.map((service) => <article className="service" key={service.number}>
